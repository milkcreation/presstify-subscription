...
<head>
    ...
    <?php /* * / ?>
    <style><?php echo file_get_contents(get_template_directory() . '/dist/css/app.mail.order.css'); ?></style>
    <?php /**/ ?>
</head>
...
<center class="center" role="article" aria-roledescription="email" lang="fr">
    ...
    <![endif]-->
                <div class="EmailContainer email-container">
                    <!--[if mso]>
                    <table class="msoTableEmailContainer" align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="680">
                        <tr>
                            <td>
                    <![endif]-->
